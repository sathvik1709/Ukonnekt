...
public class PostAnnouncementTask  extends AsyncTask<Void, Void, ArrayList > {

	PostAnnouncementParameters parameters;

	String url = "http://omega.uta.edu/~tmm4546/Ukonnekt.php?method=postAnnouncement";
	public PostAnnouncementTask(PostAnnouncementParameters postAnnouncementParameters) {
		
		this.parameters = postAnnouncementParameters;
	}
	...
	protected ArrayList doInBackground(Void... params) {
		...
		try {
            ...
            //get courseID, date, title and description of Announcement
            postParameters.add(new BasicNameValuePair("courseID", String.valueOf(parameters.getCourseID())));
            postParameters.add(new BasicNameValuePair("date",postAnnouncementDate));
